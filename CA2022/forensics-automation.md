...
Found `desktop.png` being transferred over HTTP.  However, it does not have the standard PNG header, and appears to be a base64 string.  Lets decode it:
...
Based on the above script, it looks like chunks of code were hidden in the DNS queries... specifically to `windowsliveupdater.com`.
